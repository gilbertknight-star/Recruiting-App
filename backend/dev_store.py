...
_SEED_CONTACTS = [
    ...
    # Meeting Scheduled
    {"name": "Samantha Reed", "email": "s.reed@goldmansachs.com", "title": "Partner", "firm": "Goldman Sachs", "location": "New York", "tier": "md_partner", "status": "Meeting Scheduled", "sent_at": (datetime.utcnow() - timedelta(days=22)).isoformat(), "replied_at": (datetime.utcnow() - timedelta(days=18)).isoformat()},
